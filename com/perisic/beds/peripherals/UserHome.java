...
public class UserHome extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					// System.out.println("quection set 001::::: " + questionList );
	...
	public UserHome() {
		...
		JLabel lblDoYouLike = new JLabel("Do you like to learn things by your self ?");
		...
		JLabel lblIfTheresA = new JLabel("If theres a opunity comes to you which you not expected, Do you rather take it or leave it ?");
		...
		JRadioButton rdbtnLeveIt = new JRadioButton("Leve it");
		...
		JLabel lblIfThereIs = new JLabel("If there is a situation , that you have to decide career over money, which one you choose ?");
		...
		gl_panel_Quiz2.setHorizontalGroup(
			gl_panel_Quiz2.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_panel_Quiz2.createSequentialGroup()
							...
							.addGroup(gl_panel_Quiz2.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel_Quiz2.createParallelGroup(Alignment.TRAILING)
									...
									.addComponent(lblDoYouLike, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 358, GroupLayout.PREFERRED_SIZE))))
						.addGroup(gl_panel_Quiz2.createSequentialGroup()
							.addGap(40)
				...
				.addGroup(gl_panel_Quiz2.createSequentialGroup()
					...
					.addGap(29))
				.addGroup(Alignment.LEADING, gl_panel_Quiz2.createSequentialGroup()
		...
		for (int i = 0; i < 1; i++) {
			for (int j = 0; j < questionList.get(i).size(); j++) {
				Object[] data = new Object[] { j + 1, questionList.get(1).get(j), questionList.get(0).get(j),
						questionList.get(2).get(j), "Edit" };
				// add dynamically quiestions to the form
			}
			...
			gl_panel_Quiz.setHorizontalGroup(gl_panel_Quiz.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_panel_Quiz.createSequentialGroup().addGap(26)
							...
							.addComponent(lblAreYouWorking_1, GroupLayout.PREFERRED_SIZE, 250,
