...
//					frame.setUndecorated(true);
	...
	public AdminHome(ArrayList<ArrayList<String>> value) {
		...
		String[] columns_user = new String[] { "Id", "Quection", "Answer Type", "Status", "" };
		DefaultTableModel tableModel_user = new DefaultTableModel(columns, 0);
		for (int i = 0; i < 1; i++) {
			for (int j = 0; j < value.get(i).size(); j++) {
				Object[] data = new Object[] { j + 1, value.get(1).get(j), value.get(0).get(j), value.get(2).get(j),
						"Edit" };
...
//		contentPane.add(panel_4);
		...
		btnAddNewQuestion.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Integer val;
				int result = JOptionPane.showConfirmDialog(null, myPanel, "Edit Panel", JOptionPane.OK_CANCEL_OPTION,
				...
				.addGroup(gl_panel_4.createSequentialGroup()
					...
					.addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, gl_panel_4.createSequentialGroup()
							.addComponent(btnAddNewQuestion)
							.addGap(29))))
		);
...
//		contentPane.add(panel_6);
		...
		btnAddNewUser.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				JTextField paswdField = new JTextField(1);
				JComboBox<String> statusList = new JComboBox<>(status);
				statusList.setSelectedIndex(0);
				...
				if (result == JOptionPane.OK_OPTION) {
					QuestionSet questionnaire = new QuestionSet();
					try {
						val_user = questionnaire.createPaneUser(usernameField.getText(), usernameField.getText(), paswdField.getText(), statusVal);
		...
		usrTable.getColumnModel().getColumn(4).setCellRenderer(new ButtonRendererUser());
		usrTable.getColumnModel().getColumn(4).setCellEditor(new ButtonEditorUser(new JTextField()));
